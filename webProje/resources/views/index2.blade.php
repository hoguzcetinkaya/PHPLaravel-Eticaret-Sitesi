...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li class="active-menu">
								<a href="{{route('anasayfa2')}}">Anasayfa</a>
								<!-- <ul class="sub-menu">
							...
							<li class="label1" data-label1="Yeni">
								<a href="{{route('anasayfa2')}}#selam">Ürünlerimiz</a>
								<!-- <ul class="sub-menu">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						@isset($sayac)
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="{{$sayac}}">
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				@if($urun->sepet==2)
					<li class="header-cart-item flex-w flex-t m-b-12">
						<a href="{{route('sepetKaldir',$urun->id)}}"><div class="header-cart-item-img">
							<img src="images/{{$urun->urunAd}}/{{$urun->resim}}" alt="IMG">
						</div></a>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<!--Slider1-->
				<div class="item-slick1" style="background-image: url({{asset('admin')}}/images/slider1.jpg);">
				...
				<!--Slider2 için c+p-->
				<div class="item-slick1" style="background-image: url({{asset('admin')}}/images/slider2.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$urun->kategori}}">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="images/{{$urun->urunAd}}/{{$urun->resim}}" alt="Resim Bulunamadı">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="{{route('sepetEkle',$urun->id)}}">	
								<i class="fa-solid fa-basket-shopping">Sepete Ekle</i>
								</a>
							</div>
						</div>
					</div>
