	...
	<section class="bg0 p-t-104 p-b-116">
		<div class="container">
			<div class="flex-w flex-tr">
				...
				@endif
					<form action="{{route('duzenlePost',$urunBilgi->id)}}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="urunAd" placeholder="{{$urunBilgi->urunAd}}">
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="number" name="urunFiyat" placeholder="{{$urunBilgi->urunFiyat}}">
						</div>
