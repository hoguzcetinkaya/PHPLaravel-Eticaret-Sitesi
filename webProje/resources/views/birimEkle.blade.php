	...
	<section class="bg0 p-t-104 p-b-116">
		<div class="container">
            ...
            <div class="alert alert-success">{{session('basarili')}}</div>
				...
				@endif
					<form action="{{route('birimEkle')}}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="adsoyad" placeholder="Adınız soyadınız">
						</div>
                        <div class="bor8 m-b-30">
                        <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="meslekiGorev" placeholder="Biriminiz">
						</div>
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="instagram" placeholder="Sosyal medya adresiniz(instagram)">
						</div>
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="twitter" placeholder="Sosyal medya adresiniz(twitter)">
						</div>
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="facebook" placeholder="Sosyal medya adresiniz(facebook)">
						</div>
						<div >
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
					  ...
					  @foreach($birimler as $birim)
						<tr>
							<td>{{$birim->adsoyad}}</td>
							<td>{{$birim->meslekiGorev}}</td>
							<td><a href="{{route('duzenleBirim',$birim->id)}}" class="btn btn-success" >Düzenle</a></td>
							<td><a href="{{route('kaldirBirim',$birim->id)}}" class="btn btn-danger" >Kaldır</a></td>
