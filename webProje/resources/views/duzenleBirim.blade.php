...
<body class="animsition">
	...
	<header>
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="index.html#selam">Ürün Ekle</a>
								 <!-- <ul class="sub-menu">
							...
							<li>
								<a href="about.html">Birim Ekle</a>
							...
							<li>
								<a href="contact.html">Gelen Kutusu</a>
							</li>
						</ul>
					</div>	
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="index.html#selam">Ürünlerimiz</a>
					
				</li>

				<li>
					<a href="about.html">Birimlerimiz</a>
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/iletisim.jpg');">
	...
	<section class="bg0 p-t-104 p-b-116">
		<div class="container">
			<div class="flex-w flex-tr">
				...
				@endif
					<form action="{{route('duzenleBirimPost',$birimBilgi->id)}}" method="post" enctype="multipart/form-data">
						@csrf
						...
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="adsoyad" placeholder="{{$birimBilgi->adsoyad}}">
						</div>
                        <div class="bor8 m-b-30">
                        <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="meslekiGorev" placeholder="{{$birimBilgi->meslekiGorev}}">
						</div>
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="instagram" placeholder="instagram/{{$birimBilgi->instagram}}">
						</div>
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="twitter" placeholder="twitter/{{$birimBilgi->twitter}}">
						</div>
                        <div class="bor8 m-b-30">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="facebook" placeholder="facebook/{{$birimBilgi->facebook}}">
						</div>
						<div >
